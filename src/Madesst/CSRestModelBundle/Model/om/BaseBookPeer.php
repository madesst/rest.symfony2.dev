...
namespace Madesst\CsRestModelBundle\Model\om;
...
use \PropelException;
use \PropelPDO;
use Madesst\CsRestModelBundle\Model\AuthorPeer;
use Madesst\CsRestModelBundle\Model\Book;
use Madesst\CsRestModelBundle\Model\BookPeer;
use Madesst\CsRestModelBundle\Model\map\BookTableMap;
...
abstract class BaseBookPeer
{
    ...
    const OM_CLASS = 'Madesst\\CsRestModelBundle\\Model\\Book';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Madesst\\CsRestModelBundle\\Model\\map\\BookTableMap';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Title', 'AuthorId', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'title', 'authorId', ),
        BasePeer::TYPE_COLNAME => array (BookPeer::ID, BookPeer::TITLE, BookPeer::AUTHOR_ID, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'TITLE', 'AUTHOR_ID', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'title', 'author_id', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Title' => 1, 'AuthorId' => 2, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'title' => 1, 'authorId' => 2, ),
        BasePeer::TYPE_COLNAME => array (BookPeer::ID => 0, BookPeer::TITLE => 1, BookPeer::AUTHOR_ID => 2, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'TITLE' => 1, 'AUTHOR_ID' => 2, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'title' => 1, 'author_id' => 2, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, )
    );
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseBookPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Madesst\CsRestModelBundle\Model\map\BookTableMap());
      }
    }
